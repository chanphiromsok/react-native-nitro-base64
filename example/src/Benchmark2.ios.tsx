...
// ): Uint8Array {
//   return new Uint8Array(NitroBase64HybridObject.base64ToArrayBuffer(b64, removeLinebreaks))
// }
const Benchmarks2 = () => {
  ...
  const handleNativeBase64Press = async () => {
    ...
    for (let iter = 0; iter < 30; iter++) {
      const decoded = base64FromArrayBuffer(dataToProcess);
      dataToProcess = base64ToArrayBuffer(decoded);
  ...
  return (
    <View>
      <View style={styles.lib}>
        <Text style={styles.heading}>Nitro in C++</Text>
